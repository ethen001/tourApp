...
import {signUpStudent, resetSignUpForm, resetValidError, resetSignUpError} from '../../actions'


class SignupScreenStudentComponent extends Component {
    ...
    handleSubmit() {
        const {resetValidError, signUpStudent, validError,
        ...
        if(validError) {
            ...
            signUpStudent({applicant: this.state, group, role});
        }
    }
                    ...
                    <View style={{ width: '100%', marginTop: 10, alignItems: 'center', position: 'relative' }}>
                        <DoublePicker
                            ...
                            onGroupSelected={(selection) => {
                                this.setState({tourGuide: selection.selectedTourGuide, leadChaperone: selection.selectedLeadChap})}}
                        />  
                        <TextInput
                        ...
                        <TextInput
                            ...
                            onChangeText={(emergencyContactName) => this.setState({emergencyContact:{...this.state.emergencyContact, name: emergencyContactName}})}
                        ...
                        <TextInput
                            ...
                            onChangeText={number => this.setState({emergencyContact:{...this.state.emergencyContact, number: number}})}
                        ...
                        <TextInput
                            ...
                            onChangeText={relationship => this.setState({emergencyContact:{...this.state.emergencyContact, relationship}})}
...
export const SignupScreenStudent = connect(mapStateToProps, {
    signUpStudent,
    resetSignUpForm,
    resetValidError,
    resetSignUpError
})(SignupScreenStudentComponent);
